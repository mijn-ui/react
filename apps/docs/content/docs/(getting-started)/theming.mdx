...
Mijn-UI defines color variables using a Tailwind plugin, but you can easily override them in your CSS. Use the [variables list](/docs/next-js/theming#variables-list) as a reference to redefine specific colors.
