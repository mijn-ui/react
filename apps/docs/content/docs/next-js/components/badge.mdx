...
<ComponentPreview className="flex-col md:flex-row">
  ...
  <Badge color="muted">Neutral</Badge>
...
<Badge variant="filled" color="muted">Neutral</Badge>
...
<Badge variant="outline" color="muted">Neutral</Badge>
...
<Badge variant="text" color="muted">Neutral</Badge>
