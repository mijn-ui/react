...
Mijn-UI defines color variables using a Tailwind plugin, but you can easily override them in your CSS. Use the [list of variables](docs/next-js/theming#list-of-variables) as a reference to redefine specific colors.
