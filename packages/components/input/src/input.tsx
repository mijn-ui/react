      ...
      {label && (
        <Label
          className={applyUnstyled(
            unstyled,
            cn(
              "text-neutral-text absolute start-2 top-2 z-10 max-w-fit origin-[0] -translate-y-4 scale-75 cursor-text bg-transparent px-2 text-sm duration-300",
              startIcon || endIcon
