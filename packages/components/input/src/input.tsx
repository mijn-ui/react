    ...
    >
      {startIcon && (
        <div
          className={applyUnstyled(
            unstyled,
            "[&>svg]:text-neutral-text absolute left-2 top-1/2 -translate-y-1/2 transform text-base",
      ...
      <input
        ...
        className={applyUnstyled(
          unstyled,
          cn(
            "peer flex h-10 w-full rounded-md border border-main-border bg-transparent px-3 py-2 text-sm outline-none file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-neutral-text focus-visible:border-input-border focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring focus-visible:ring-offset-0 disabled:cursor-not-allowed",
            startIcon ? "pl-8" : "",
            endIcon ? "pr-8" : "",
          ),
          classNames?.input,
      ...
      {label && (
        <Label
          className={applyUnstyled(
            unstyled,
            cn(
              "absolute start-2 top-2 z-10 max-w-fit origin-[0] -translate-y-4 scale-75 cursor-text bg-transparent px-2 text-sm text-neutral-text duration-300",
              startIcon || endIcon
      ...
      {endIcon && (
        <div
          className={applyUnstyled(
            unstyled,
            "[&>svg]:text-neutral-text absolute right-3.5 top-1/2 -translate-y-1/2 transform text-base",
            classNames?.endIcon,
          )}
        >
          {endIcon}
